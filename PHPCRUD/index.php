  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="insertcode.php" name = "myForm" onsubmit = "return(validate());" method="POST">
...
<script>
   ...
   success:function(data)
   {
    ...
    if(data.row_data)
    {
     for(var count = 0; count < data.row_data.length; count++)
     {
      ...
      html += '<td class="duration" contenteditable>'+data.row_data[count].duration+'</td>'
      html += '<td class="email_id" contenteditable>'+data.row_data[count].email_id+'</td></tr>';
 ...
 $(document).on('click', '#import_data', function(){
  ...
  $('.email_id').each(function(){
   email_id.push($(this).text());
  });
  $.ajax({
   url:"import.php",
   method:"post",
   data:{fname:fname, occupation:occupation, duration:duration, email_id:email_id},
   success:function(data)
   {
