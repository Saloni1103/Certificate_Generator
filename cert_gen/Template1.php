...
<html lang="en">
        ...
        if ($name == "" || $occupation == "" || $date == "") {
		  ...
		  function generateKey($conn)
		  {
			  ...
			  if ($checkKey == true) {
				  ...
				  $newUser="INSERT INTO codetab(v_key,url) values('$randstr', '$output')";
 ...
 ?>
        ...
        <a href="<?php echo ""; ?>" class="btn btn-success">Download My Internship Certificate</a>
        <br><br>
<?php 
		$file=time();
